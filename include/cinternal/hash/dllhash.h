...
#define CInternalDLLHashItemFromListIterator(_iter_ptr)	\
	cpputils_container_of(cpputils_container_of(_iter_ptr,const struct SCinternalListIteratorWithData,itr),const struct SCinternalLHashItem,lst)
