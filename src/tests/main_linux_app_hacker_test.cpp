...
//int main()
//{
//    dlopen("aaa.so",RTLD_LAZY);
//    dlopen("aaa2.so",RTLD_LAZY);
//
//    return 0;
//}
...
void putdata(pid_t child, unsigned long long addr,
             unsigned char *str, int len)
{   unsigned char *laddr;
    int i, j;
    union u {
...
{   pid_t traced_process;
    ...
    unsigned char insertcode[] = {
        0xbe,    0x01,    0x00,    0x00,    0x00,    0x48,    0x8d,    0x3d,
        0x83,    0x09,    0x00,    0x00,    0xe8,    0x6a,    0xea,    0xff,
        0xff
    };
    const int len = sizeof(insertcode);
