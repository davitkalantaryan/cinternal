//
// file:            cinternal_core_loadlib_on_remote_process_unix.c
// path:			src/core/cinternal_core_loadlib_on_remote_process_unix.c
...
{
    return CInternalLoadLibOnRemoteProcessAnGetModule(a_pid,a_libraryName) ? true : false;
}
