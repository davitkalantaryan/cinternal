...
extern CPPUTILS_DLL_PRIVATE void _CinternalAddUnitTestFunction(TypeFunction a_function) __attribute__((weak_import));
extern CPPUTILS_DLL_PRIVATE void _CinternalIterateAndCallUnitTestFunctions(void) __attribute__((weak_import));
